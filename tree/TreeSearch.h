...
class TreeSearch:public QObject
{
    Q_OBJECT
public:
        TreeSearch();
        ~TreeSearch();
signals:
        void expandModel(QModelIndex indexSearched);

public slots:

        static void SearchItem(QStandardItemModel *, const QString &);//搜索函数
//        void SearchItem(QString keyWord, QString keyWord2){
//            qDebug() << "TreeModel SearchItem KeyWord is: "<<keyWord <<
